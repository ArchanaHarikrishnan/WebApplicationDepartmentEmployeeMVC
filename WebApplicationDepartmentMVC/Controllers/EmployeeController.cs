...
namespace WebApplicationDepartmentMVC.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        private async Task<bool> PostEmployeeAsync(Employee employee)
        {
            ...
            HttpResponseMessage response = await client.PostAsync("api/EmployeeTbls", content);
        ...
        private static async Task<List<Employee>> GetEmployeesAsync()
        {
            ...
            // Call the API
            HttpResponseMessage response = await client.GetAsync("api/EmployeeTbls");
        ...
        public async Task<IActionResult> UpdateEmployee(int id, Employee employee)
        {
            ...
            string apiUrl = $"https://localhost:7185/api/EmployeeTbls/{id}";
        ...
        private static async Task<Employee> GetEmployeesAsync(int id)
        {
            ...
            HttpResponseMessage response = await client.GetAsync($"api/EmployeeTbls/{id}");
            // Check if the request was successful
            if (response.IsSuccessStatusCode)
            {
        ...
        private async Task<bool> DeleteEmployeeAsync(int id)
        {
            ...
            HttpResponseMessage response = await client.DeleteAsync($"api/EmployeeTbls/{id}");
