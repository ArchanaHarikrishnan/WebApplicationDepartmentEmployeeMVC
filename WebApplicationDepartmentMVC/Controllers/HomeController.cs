...
using System.Text;
using WebApplicationDepartmentMVC.Models;
using Newtonsoft.Json;

namespace WebApplicationDepartmentMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        private async Task<bool> PostDepartmentAsync(Department department)
        {
            ...
            HttpResponseMessage response = await client.PostAsync("api/DepartmentTbls", content);
        ...
        private static async Task<List<Department>> GetDepartmentsAsync()
        {
            ...
            // Call the API
            HttpResponseMessage response = await client.GetAsync("api/DepartmentTbls");
        ...
        public async Task<IActionResult> UpdateDepartment(int id, Department department)
        {
            ...
            string apiUrl = $"https://localhost:7185/api/DepartmentTbls/{id}";
        ...
        private static async Task<Department> GetDepartmentsAsync(int id)
        {
            ...
            HttpResponseMessage response = await client.GetAsync($"api/DepartmentTbls/{id}");
            // Check if the request was successful
            if (response.IsSuccessStatusCode)
            {
                // Deserialize the JSON response to a List<Department>
        ...
        public async Task<bool> DeleteDepartmentAsync(int id)
        {
            ...
            HttpResponseMessage response = await client.DeleteAsync($"api/DepartmentTbls/{id}");
